...
- **Data-Path (eBPF)** — High-performance, scalable datapath powered by [eBPF](https://ebpf.io/)  
- **Routing Stack** — Integrated BGP support using a built-in [GoBGP](https://github.com/osrg/gobgp) based implementation  
- **Kubernetes Integration** — A native Kubernetes agent, [kube-loxilb](https://github.com/loxilb-io/kube-loxilb), written in Go for seamless service discovery and synchronization
